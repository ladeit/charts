#!/bin/bash
#
# deploy ladeit charts to ladeit.github.io
#
...
git config --global user.email "jiiiuxiii@gmail.com"
git config --global user.name "ladeit"
git add --all .
git commit -m "Push ladeit Helm chart via Github actions build nr ${GITHUB_RUN_NUMBER}"
